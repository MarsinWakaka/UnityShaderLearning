    ...
    SubShader{
        Pass{
            ...
            v2f vert(a2v v){
                ...
                fixed3 diffuse = _Diffuse.rgb * _LightColor0.rgb * saturate(dot(worldLightDir, worldNormal));

                fixed3 reflectDir = normalize(reflect( -worldLightDir, worldNormal));
                fixed3 viewDir = normalize(_WorldSpaceCameraPos.xyz - mul(UNITY_MATRIX_M, v.vertex).xyz);
